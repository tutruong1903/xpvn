...
(function () {
  ...
  function setLocale(locale) {
    ...
    document.cookie =
      "sspanel_locale=" + locale + "; path=/; max-age=31536000; SameSite=Lax";
  ...
  function applyTranslations(locale) {
    ...
    document
      .querySelectorAll("[data-i18n-user-edit-ph]")
      .forEach(function (el) {
    ...
    document
      .querySelectorAll("[data-i18n-user-order-ph]")
      .forEach(function (el) {
    ...
    var _userOrderDict = flattenAdminSection(
      flattenNestedSection(orderDict),
      "user.order.",
    );
    applyAttributeFromDict(
      "[data-i18n^='user.order.']",
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='user.order.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='user.invoice.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
        var val = _userInvoiceDict[key];
        if (val) el.setAttribute("placeholder", val);
      });
    ...
    document
      .querySelectorAll("[data-i18n-user-ticket-ph]")
      .forEach(function (el) {
    ...
    document
      .querySelectorAll("[data-i18n-user-ticket-title]")
      .forEach(function (el) {
    ...
    applyAttributeFromDict(
      ...
      "data-i18n",
      flattenAdminSection(
        getAdminSectionDict(locale, "header"),
        "admin.header.",
      ),
    );
    applyAttributeFromDict(
      ...
      "data-i18n",
      flattenAdminSection(
        getAdminSectionDict(locale, "dialog"),
        "admin.dialog.",
      ),
    );
    ...
    var _adminUserDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "user")),
      "admin.user.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.user.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    var _adminNodeDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "node")),
      "admin.node.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.node.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    var _adminSystemDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "system")),
      "admin.system.",
    );
    applyAttributeFromDict(
    ...
    var _adminBillingDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "billing")),
      "admin.billing.",
    );
    applyAttributeFromDict(
    ...
    var _adminEmailDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "email")),
      "admin.email.",
    );
    applyAttributeFromDict(
    ...
    var _adminSupportDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "support")),
      "admin.support.",
    );
    applyAttributeFromDict(
    ...
    var _adminCaptchaDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "captcha")),
      "admin.captcha.",
    );
    applyAttributeFromDict(
    ...
    var _adminRegDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "reg")),
      "admin.reg.",
    );
    applyAttributeFromDict(
      "[data-i18n^='admin.reg.']",
    ...
    var _adminRefDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "ref")),
      "admin.ref.",
    );
    applyAttributeFromDict(
      "[data-i18n^='admin.ref.']",
    ...
    var _adminImDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "im")),
      "admin.im.",
    );
    applyAttributeFromDict(
      "[data-i18n^='admin.im.']",
    ...
    var _adminSubDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "sub")),
      "admin.sub.",
    );
    applyAttributeFromDict(
      "[data-i18n^='admin.sub.']",
    ...
    var _adminCronDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "cron")),
      "admin.cron.",
    );
    applyAttributeFromDict(
    ...
    var _adminFeatureDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "feature")),
      "admin.feature.",
    );
    applyAttributeFromDict(
    ...
    var _adminLlmDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "llm")),
      "admin.llm.",
    );
    applyAttributeFromDict(
      "[data-i18n^='admin.llm.']",
    ...
    var _adminProductDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "product")),
      "admin.product.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.product.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    var _adminOrderDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "order")),
      "admin.order.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.order.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    var _adminInvoiceDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "invoice")),
      "admin.invoice.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.invoice.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    var _adminCouponDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "coupon")),
      "admin.coupon.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.coupon.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
    ...
    var _adminGiftcardDict = flattenAdminSection(
      flattenNestedSection(getAdminSectionDict(locale, "giftcard")),
      "admin.giftcard.",
    );
    applyAttributeFromDict(
    ...
    document
      .querySelectorAll("[data-i18n-placeholder^='admin.giftcard.']")
      .forEach(function (el) {
        var key = el.getAttribute("data-i18n-placeholder");
