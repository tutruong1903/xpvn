...
return [
    ...
    'admin_ann' => [
        ...
        'add_failed'                           => '公告保存失败',
        'add_success'                          => '公告添加成功',
        'add_success_email_success'            => '公告添加成功，邮件发送成功',
        'add_success_bot_failed'               => '公告添加成功，IM Bot 发送失败',
        'add_success_email_success_bot_failed' => '公告添加成功，邮件发送成功，IM Bot 发送失败',
        'not_found'                            => '公告不存在',
        'update_failed'                        => '公告更新失败',
        'update_success'                       => '公告更新成功',
        'update_success_bot_failed'            => '公告更新成功，IM Bot 发送失败',
        'delete_success'                       => '删除成功',
        'delete_failed'                        => '删除失败',
    ],    'admin_docs' => [
        'title_content_empty' => '文档标题和内容不能为空',
        'add_failed'          => '文档添加失败',
        'add_success'         => '文档添加成功',
    ...
    'password' => [
        ...
        'email_required' => '未填写邮箱',
        'request_too_frequent' => '你的请求过于频繁，请稍后再试',
        'reset_mail_sent' => '如果你的账户存在于我们的数据库中，那么重置密码的链接将会发送到你账户所对应的邮箱',
        'email_send_failed' => '邮件发送失败',
        'password_mismatch' => '两次输入不符合',
    ...
    'oauth' => [
        'err_msg' => 'OAuth 请求失败',
        'slack_bound' => 'Slack 账户已绑定',
        'discord_bound' => 'Discord 账户已绑定',
        'telegram_bound' => 'Telegram 账户已绑定',
        'bind_success' => '绑定成功',
    ],
    'gateway' => [
        'invalid_amount' => '非法的金额',
        'payment_failed' => '请求支付失败，网关错误',
        'exchange_failed' => '汇率获取失败',
    ],
    'subscribe_log' => [
        'unknown_location' => '未知',
    ],
