...
(function () {
  ...
  function bindEvents(container) {
    container.querySelectorAll("[data-locale]").forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        document
          .querySelectorAll(".locale-switcher-root [data-locale]")
          .forEach(function (a) {
  ...
  function updateAllLabels(locale) {
    document
      .querySelectorAll("#locale-switcher-btn, .locale-switcher-btn")
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (legacy) {
      ...
      if (
        legacyRoot &&
        !legacyRoot.classList.contains("locale-switcher-root")
      ) {
        legacyRoot.remove();
      }
    }
    ...
    // Normalize all rendered/legacy switcher buttons to: flag + label (no icon)
    updateAllLabels(getLocale());
  });
