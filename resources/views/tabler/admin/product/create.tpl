...
<link href="/assets/css/admin/product-create.css{asset_ver path="/assets/css/admin/product-create.css"}" rel="stylesheet"/>

<div class="container-xl">
    <!-- Page Header -->
    <div class="lmn-page-header">
        <div class="lmn-page-header__content">
            <h2 class="lmn-page-title" data-i18n="admin.product.create.title">创建商品</h2>
            <p class="lmn-page-subtitle" data-i18n="admin.product.create.subtitle">配置新的订阅套餐或充值包。</p>
        </div>
    </div>
</div>
        ...
        <div class="lmn-edit-grid">
                ...
                <div class="lmn-edit-card">
                    ...
                    <div class="lmn-edit-fields">
                        ...
                        <div class="lmn-edit-field">
                            ...
                            <input id="price" type="number" step="0.01" min="0" class="lmn-edit-input" value="">
                        </div>
                        <div class="lmn-edit-field">
                            <label class="lmn-edit-label" data-i18n="admin.product.create.field_stock">库存（-1为不限制）</label>
                            <input id="stock" type="number" min="-1" class="lmn-edit-input" value="-1">
                        </div>
                        <div class="lmn-edit-field">
                            <label class="lmn-edit-label" data-i18n="admin.product.create.field_status">销售状态</label>
                            <select id="status" class="lmn-edit-select">
                                <option value="1" data-i18n="admin.product.create.status_active">正常</option>
                                <option value="0" data-i18n="admin.product.create.status_inactive">下架</option>
                            </select>
                        </div>
                        <div class="lmn-edit-field">
                            <label class="lmn-edit-label" data-i18n="admin.product.create.field_type">类型</label>
                            <input id="type" type="hidden" value="tabp">
                            <div class="lmn-type-switcher">
                                <button type="button" class="lmn-type-btn is-active" data-type="tabp">
                                ...
                                <button type="button" class="lmn-type-btn" data-type="bandwidth">
                                ...
                                <button type="button" class="lmn-type-btn" data-type="time">
                ...
                <div class="lmn-edit-card">
                    ...
                    <div class="lmn-edit-fields">
                        <div id="time_option" class="lmn-edit-field lmn-dynamic-field">
                            ...
                            <input id="time" type="number" min="1" class="lmn-edit-input" value="">
                        </div>
                        <div id="class_option" class="lmn-dynamic-field">
                            <div class="lmn-edit-field">
                                ...
                                <input id="class" type="hidden" value="0">
                        ...
                        <div id="class_time_option" class="lmn-edit-field lmn-dynamic-field">
                            ...
                            <input id="class_time" type="number" min="1" class="lmn-edit-input" value="">
                        </div>
                        <div id="bandwidth_option" class="lmn-edit-field lmn-dynamic-field">
                            ...
                            <div class="lmn-input-unit-wrap">
                                <input id="bandwidth" type="number" min="1" class="lmn-edit-input" value="">
                        ...
                        <div id="speed_limit_option" class="lmn-edit-field lmn-dynamic-field">
                            ...
                            <div class="lmn-input-unit-wrap">
                                <input id="speed_limit" type="number" min="0" class="lmn-edit-input" value="0">
                        ...
                        <div id="ip_limit_option" class="lmn-edit-field lmn-dynamic-field">
                            ...
                            <input id="ip_limit" type="number" min="0" class="lmn-edit-input" value="0">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lmn-edit-col">
                <div class="lmn-edit-card">
                    ...
                    <div class="lmn-edit-fields">
                        <div class="lmn-edit-field">
                            ...
                            <input id="class_required" type="hidden" value="">
                            <div class="lmn-level-picker lmn-level-picker--5col" data-for="class_required">
                                <button type="button" class="lmn-level-btn is-active" data-level="">
                                    <span class="lmn-level-btn__name" data-i18n="admin.product.create.level_any">任意</span>
                                </button>
                                <button type="button" class="lmn-level-btn" data-level="0">
                                    <span class="lmn-level-btn__name" data-i18n="admin.product.create.level_basic">Basic</span>
                                </button>
                                <button type="button" class="lmn-level-btn" data-level="1">
                                    <span class="lmn-level-btn__name" data-i18n="admin.product.create.level_standard">Standard</span>
                        ...
                        <div class="lmn-edit-field">
                            ...
                            <input id="node_group_required" type="text" class="lmn-edit-input" value="">
                        </div>
                        <div class="lmn-edit-toggle-row">
                            ...
                            <label class="lmn-toggle">
                                <input id="new_user_required" type="checkbox" class="lmn-toggle-input">
                ...
                <div class="lmn-edit-actions">
                    <button id="create-product" type="button" class="lmn-btn-save">
                        <span data-i18n="admin.product.create.save_btn">保存</span>
                    </button>
...
<script>
    ...
    // Initialize for default type
    updateDynamicFields('tabp');
