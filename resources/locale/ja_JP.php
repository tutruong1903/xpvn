...
return [
    ...
    'admin_ann' => [
        'content_empty'                        => '内容を入力してください',
        'add_failed'                           => 'お知らせの保存に失敗しました',
        'add_success'                          => 'お知らせを追加しました',
        'add_success_email_success'            => 'お知らせを追加し、メール通知を送信しました',
        'add_success_bot_failed'               => 'お知らせを追加しましたが、IM Botの通知に失敗しました',
        'add_success_email_success_bot_failed' => 'お知らせを追加し、メールを送信しましたが、IM Botの通知に失敗しました',
        'not_found'                            => 'お知らせが見つかりません',
        'update_failed'                        => 'お知らせの更新に失敗しました',
        'update_success'                       => 'お知らせを更新しました',
        'update_success_bot_failed'            => 'お知らせを更新しましたが、IM Botの通知に失敗しました',
        'delete_success'                       => '削除しました',
        'delete_failed'                        => '削除に失敗しました',
    ],
    'admin_docs' => [
        'title_content_empty' => 'タイトルと内容を入力してください',
        'add_failed'          => 'ドキュメントの追加に失敗しました',
        'add_success'         => 'ドキュメントを追加しました',
        'generate_success'    => 'ドキュメントを生成しました',
    ...
    'password' => [
        'captcha_error' => 'システムはあなたの検証結果を受け入れられません。ページを更新してもう一度お試しください。',
        'email_required' => 'メールアドレスが入力されていません',
        'request_too_frequent' => 'リクエストが多すぎます。しばらくしてから再試行してください',
        'reset_mail_sent' => 'アカウントがデータベースに存在する場合、パスワードリセットリンクが登録メールアドレスに送信されます',
        'email_send_failed' => 'メール送信に失敗しました',
        'password_mismatch' => '2つのパスワードが一致しません',
        'password_too_short' => 'パスワードが短すぎます',
        'link_invalid' => 'リンクが無効です',
        'reset_failed' => 'リセットに失敗しました。再試行してください',
    ...
    'oauth' => [
        'err_msg' => 'OAuthリクエストに失敗しました',
        'slack_bound' => 'Slackアカウントは既にバインドされています',
        'discord_bound' => 'Discordアカウントは既にバインドされています',
        'telegram_bound' => 'Telegramアカウントは既にバインドされています',
        'bind_success' => 'バインドに成功しました',
    ],
    'gateway' => [
        'invalid_amount' => '無効な金額',
        'payment_failed' => '支払いリクエストに失敗しました、ゲートウェイエラー',
        'exchange_failed' => '為替レートの取得に失敗しました',
    ],
    'subscribe_log' => [
        'unknown_location' => '不明',
    ],
