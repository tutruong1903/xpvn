/**
 * Admin Sidebar Toggle (Collapse/Expand + Mobile)
 * Handles admin sidebar collapse state, mobile toggle, and tooltip updates
 */
(function () {
...
window.updateCollapsedSidebarTooltips = function () {
    ...
    document.querySelectorAll('#sidebar .nav-link[data-path]').forEach(function (link) {
        var titleEl = link.querySelector('.nav-link-title, .sidebar-nav-link__title');
