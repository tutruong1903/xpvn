...
return [
    ...
    'admin_ann' => [
        ...
        'add_failed'                           => 'Lưu thông báo thất bại',
        'add_success'                          => 'Thêm thông báo thành công',
        'add_success_email_success'            => 'Thêm thông báo thành công, đã gửi email thông báo',
        'add_success_bot_failed'               => 'Thêm thông báo thành công, gửi thông báo IM Bot thất bại',
        'add_success_email_success_bot_failed' => 'Thêm thông báo thành công, đã gửi email, gửi thông báo IM Bot thất bại',
        'not_found'                            => 'Thông báo không tồn tại',
        'update_failed'                        => 'Cập nhật thông báo thất bại',
        'update_success'                       => 'Cập nhật thông báo thành công',
        'update_success_bot_failed'            => 'Cập nhật thông báo thành công, gửi thông báo IM Bot thất bại',
        'delete_success'                       => 'Xóa thông báo thành công',
        'delete_failed'                        => 'Xóa thông báo thất bại',
    ],    'admin_docs' => [
        'title_content_empty' => 'Tiêu đề và nội dung không được để trống',
        'add_failed'          => 'Thêm tài liệu thất bại',
        'add_success'         => 'Thêm tài liệu thành công',
        'generate_success'    => 'Tạo tài liệu thành công',
        'not_found'           => 'Tài liệu không tồn tại',
        'update_failed'       => 'Cập nhật tài liệu thất bại',
        'update_success'      => 'Cập nhật tài liệu thành công',
        'delete_success'      => 'Xóa tài liệu thành công',
        'delete_failed'       => 'Xóa tài liệu thất bại',
    ],    'ticket' => [
    ...
    'rate' => [
        'node_not_found' => 'Không tìm thấy máy chủ',
        'no_nodes' => 'Không có máy chủ nào',
    ],
    'admin_billing' => [
    ...
    'password' => [
        ...
        'email_required' => 'Chưa điền email',
        'request_too_frequent' => 'Yêu cầu của bạn quá thường xuyên, vui lòng thử lại sau',
        'reset_mail_sent' => 'Nếu tài khoản của bạn tồn tại trong hệ thống, liên kết đặt lại mật khẩu sẽ được gửi đến email đã đăng ký',
    ...
    'oauth' => [
        'err_msg' => 'Yêu cầu OAuth thất bại',
        'slack_bound' => 'Tài khoản Slack đã được liên kết',
        'discord_bound' => 'Tài khoản Discord đã được liên kết',
        'telegram_bound' => 'Tài khoản Telegram đã được liên kết',
        'bind_success' => 'Liên kết thành công',
    ],
    'gateway' => [
        'invalid_amount' => 'Số tiền không hợp lệ',
        'payment_failed' => 'Yêu cầu thanh toán thất bại, lỗi cổng thanh toán',
        'exchange_failed' => 'Lấy tỷ giá thất bại',
    ],
    'subscribe_log' => [
        'unknown_location' => 'Không rõ',
    ],
];
