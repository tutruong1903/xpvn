...
<head>
    ...
    <title data-i18n="password_token.brand">{$config['appName']}</title>
...
<body>
    ...
    <div class="auth-page">
        <div class="auth-card">
            <!-- Brand -->
            <div class="auth-brand" data-i18n="password_token.brand">{$config['appName']}</div>
            
            <!-- Heading -->
            <h1 class="auth-heading" data-i18n="password_token.heading">Set new password</h1>
            
            <!-- Token Form -->
            <form id="token-form">
                <!-- New Password -->
                <div class="form-group">
                    <label class="auth-label" data-i18n="password_token.password_label">New password</label>
                    <input 
                        id="password" 
                        type="password" 
                        class="auth-input" 
                        placeholder="Enter new password"
                        data-i18n-placeholder="password_token.password_placeholder"
                        required
                        autocomplete="off"
                    />
                </div>
                ...
                <!-- Confirm Password -->
                <div class="form-group">
                    <label class="auth-label" data-i18n="password_token.confirm_password_label">Confirm new password</label>
                    <input 
                        id="confirm_password" 
                        type="password" 
                        class="auth-input" 
                        placeholder="Re-enter new password"
                        data-i18n-placeholder="password_token.confirm_password_placeholder"
                        required
                        autocomplete="off"
                    />
                </div>
                ...
                >
                    <span data-i18n="password_token.reset_button">Reset</span>
            ...
            <div class="auth-footer">
                <span data-i18n="password_token.has_account">Already have an account?</span>
                <a href="/auth/login" class="auth-link" data-i18n="password_token.login_link">Login here</a>
            </div>
        </div>
    </div>
...
<div style="display: none;" id="success-dialog">
    <div style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 2rem; border-radius: 1rem; box-shadow: 0 20px 60px rgba(0,0,0,0.2); z-index: 10000; max-width: 400px; width: 90%;">
        <div style="text-align: center;">
            ...
            <button onclick="authModals.success.hide(); location.href='/auth/login'" style="margin-top: 1.5rem; padding: 0.75rem 2rem; background: #2fb344; color: white; border: none; border-radius: 0.5rem; cursor: pointer; font-weight: 600;">OK</button>
        </div>
    </div>
